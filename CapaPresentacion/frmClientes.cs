...
namespace CapaPresentacion
{
    public partial class frmClientes : Form
    {
        ...
        private void btnguardar_Click(object sender, EventArgs e)
        {
                ...
                cboestado.SelectedItem == null)
            {
                ...
                MostrarMensaje("Por favor, complete todos los campos antes de guardar.");
                return;
            }
            ...
            else
            {
                ...
                if (resultado)
                {
                    ...
                    // Mostrar mensaje de éxito
                    MostrarMensaje("¡Edición exitosa!");
                }
                else
                {
                    // Mostrar mensaje de error
        ...
        {
            // Instanciar y mostrar el formulario de mensaje
    ...
    public class MensajeForm : Form
    {
        ...
        public MensajeForm()
        {
            ...
            btnCerrar.Location = new System.Drawing.Point(100, 70);
